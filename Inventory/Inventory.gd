...
func _process(_delta):
	$TextureRect/StrengthLabel.text = "Strength : " +  str(PlayerStats.STRENGTH)
	$TextureRect/SanityLabel.text = "Sanity : " + str(PlayerStats.SANITY) + "/" + str(PlayerStats.MAX_SANITY)
	$TextureRect/IntelligenceLabel.text = "Intelligence : " + str(PlayerStats.INTELLIGENCE)
...
func _ready():
	...
	equip_slots[1].slotType = SlotClass.SlotType.CHEST
...
func able_to_put_into_slot(slot: SlotClass):
	...
	elif slot.slotType == SlotClass.SlotType.CHEST:
